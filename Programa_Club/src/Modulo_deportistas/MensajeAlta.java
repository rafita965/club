 ...
 * @author tm_galli
 */
public class MensajeAlta extends javax.swing.JFrame {

    /**
     * Creates new form MensajeAlta
     */
    public MensajeAlta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Has dado de alta al deportista");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MensajeAlta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MensajeAlta().setVisible(true);
            }
        });
    }
