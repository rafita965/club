 ...
 * @author tm_galli
 */
public class MensajePruebaJuveniles extends javax.swing.JFrame {

    /** Creates new form MensajeEntrenamientosVer */
    public MensajePruebaJuveniles() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Prueba Juveniles");
        ...
        jLabel2.setText("Has asignado fecha de Pruebas Juveniles");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MensajePruebaJuveniles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MensajePruebaJuveniles().setVisible(true);
            }
        });
    }
