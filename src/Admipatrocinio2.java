...
public class Admipatrocinio2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            List<String> listaPatrocinios;
            listaPatrocinios = consulta();
            
            jList1.setModel(new javax.swing.AbstractListModel<String>() {
            public int getSize() {
                return listaPatrocinios.size(); // Tamaño de la lista
            }

            public String getElementAt(int i) {
                return listaPatrocinios.get(i); // Devuelve el elemento correspondiente
            }
        });
        
        // Establecer el JList dentro de un JScrollPane
    ...
    try {
        ...
        String queryUsuario = "SELECT * FROM Patrocinio";
    ...
    private javax.swing.JComboBox patrocionio_ele;
